      ...
      <div className="max-w-4xl mx-auto">
        <header className="flex justify-between items-center mb-8">
          ...
          <input 
            ...
            className="bg-slate-900 border border-white/10 px-4 py-2 rounded-lg text-sm focus:outline-none focus:border-[#10b981] w-64"
          ...
          {results.map((match) => (
            <div key={match.id} className="bg-slate-900/50 border border-white/5 rounded-2xl p-5 hover:bg-slate-900 transition-colors">
              ...
              <div className="flex items-center justify-between">
                <div className="w-1/3 text-right font-bold text-base">{match.home_name}</div>
                
                <div className="flex flex-col items-center px-6">
                  <div className="text-2xl font-black text-yellow-400 bg-black px-4 py-1 rounded-xl border border-white/5 tracking-widest">
                ...
                <div className="w-1/3 text-left font-bold text-base">{match.away_name}</div>
              </div>
            </div>
          ))}
        </div>
