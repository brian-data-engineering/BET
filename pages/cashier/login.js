    ...
    <div className="min-h-screen bg-[#0b0f1a] text-white flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-[440px] z-10">
        <div className="bg-[#111926] border border-white/5 rounded-[3rem] p-10 shadow-2xl">
          ...
          {errorMsg && (
            <div className="mb-8 bg-red-500/10 border border-red-500/20 p-5 rounded-2xl flex items-start gap-4">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-[#0b0f1a] border border-white/5 p-5 rounded-2xl outline-none focus:border-[#10b981] transition-all text-sm font-bold uppercase" 
            ...
            <button 
              disabled={loading} 
              className="w-full bg-[#10b981] text-black font-black py-6 rounded-2xl hover:bg-white active:scale-[0.97] transition-all flex items-center justify-center gap-3 italic"
            >
              {loading ? (
