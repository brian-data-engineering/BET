...
import { Ticket, Users, Wallet, TrendingUp, Activity, PlusCircle, ShieldCheck } from 'lucide-react';
      ...
      <div className="p-8 space-y-8 bg-[#0b0f1a] min-h-screen text-white font-sans">
        <div className="flex justify-between items-end">
          ...
          <div className="bg-[#10b981]/5 px-5 py-3 rounded-2xl border border-[#10b981]/10 flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-[#10b981] uppercase italic tracking-widest">{profile.username}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          <div className="xl:col-span-2 bg-[#111926] border border-white/5 rounded-[2.5rem] overflow-hidden">
            ...
            <table className="w-full text-left">
              <thead className="bg-[#0b0f1a]/50 text-slate-600 text-[9px] font-black uppercase italic tracking-widest">
                <tr><th className="p-6">Serial</th><th className="p-6">Stake</th><th className="p-6 text-center">Odds</th><th className="p-6 text-right">Time</th></tr>
              </thead>
          ...
          <div className="bg-gradient-to-br from-[#10b981] to-[#059669] p-8 rounded-[2.5rem] text-black h-fit shadow-xl shadow-[#10b981]/10">
               <h3 className="text-xl font-black uppercase italic tracking-tighter mb-2">Provisioning</h3>
               <p className="text-[10px] font-bold uppercase mb-6 italic opacity-80">Expand your network nodes instantly.</p>
               <button onClick={() => window.location.href = profile.role?.includes('admin') ? '/admin/operator' : '/operator/staff'} className="w-full bg-white text-black font-black py-4 rounded-2xl text-xs uppercase italic tracking-widest active:scale-95 transition-all">
