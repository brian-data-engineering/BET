    ...
    <AdminLayout>
      <div className="p-8 space-y-10 bg-[#0b0f1a] min-h-screen text-white font-sans">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-10">
          ...
          {/* Sidebar: Health & Settlement */}
          <div className="space-y-8">
            <div className="bg-[#111926] p-10 rounded-[3rem] border border-white/5 space-y-8 shadow-2xl">
            ...
            <div className="bg-[#10b981] p-10 rounded-[3rem] text-black shadow-2xl shadow-[#10b981]/10">
              ...
              <p className="text-4xl font-black italic tracking-tighter mb-4">
