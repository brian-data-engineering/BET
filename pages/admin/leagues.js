        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Trust & Verification Layer</span>
            </div>
          ...
          {loading ? (
            ...
            filteredMappings.map((item) => (
              <div key={item.id} className={`bg-[#111926] border ${item.is_verified ? 'border-[#10b981]/30 bg-[#10b981]/[0.02]' : 'border-orange-500/20'} p-6 rounded-[2rem] flex flex-col lg:flex-row items-center justify-between gap-6 transition-all`}>
                ...
                {/* Left Section: Source vs Official */}
                ...
                {/* Actions Section: Selector & Verification Toggle */}
                <div className="flex items-center gap-4 w-full lg:w-auto">
                  ...
                  >
                    ...
                    {soccerLeagues.map(l => (
                      <option key={l.league_id} value={l.league_name} className="bg-[#111926]">
                        {l.league_name}
                      </option>
                    ))}
                  </select>
