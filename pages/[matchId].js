                ...
                {mainMarkets.map((odd, idx) => {
                  ...
                  return (
                    <button 
                      ...
                      className={`flex flex-col items-center justify-center p-4 h-16 rounded-md border transition-all ${
                        isSelected ? 'bg-[#10b981] border-[#10b981] text-white' : 'bg-[#111926] border-white/5 text-slate-300'
                      }`}
                    >
                      <span className="text-[9px] font-black uppercase mb-1 opacity-60">{odd.display}</span>
                ...
                <div className={`grid gap-2 ${market.odds?.length > 3 ? 'grid-cols-2' : 'grid-cols-3'}`}>
                  {market.odds?.map((odd, oIdx) => {
                    ...
                    return (
                      ...
                      >
                        <span className="text-[8px] font-black uppercase mb-1 leading-none opacity-60">{odd.display}</span>
