...
import { Trophy, ChevronRight, ChevronDown, FilterX, Globe, Search } from 'lucide-react';
...
const Sidebar = ({ onSelectLeague, onClearFilter }) => {
  ...
  return (
    <div className="w-full bg-[#111926] text-slate-300 min-h-screen select-none">
                    ...
                    {Object.keys(countries).length === 0 ? (
                      ...
                      Object.keys(countries).map(country => (
                        <div key={country} className="border-t border-white/5 first:border-0">
                          <div className="px-6 py-2 flex items-center gap-2 bg-white/5">
