...
export default function Betslip({ items = [], setItems }) {
  ...
  // 1. Precise Clock Sync (Every 5 seconds for high-stakes accuracy)
  useEffect(() => {
  ...
  const isLocked = (startTime) => {
    ...
    try {
      ...
      const lockTime = matchDate.getTime() - 60000; // 60s before kickoff
  ...
  return (
    <div className="bg-[#111926] border border-white/5 lg:rounded-3xl overflow-hidden flex flex-col max-h-[calc(100vh-120px)] sticky top-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] w-full transition-all">
                ...
                <div key={item.id} className={`group bg-[#1c2636]/40 border rounded-2xl relative transition-all duration-300 ${warning ? 'border-orange-500/30' : 'border-white/5 hover:border-white/10'}`}>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      <span className="text-base font-black text-[#f59e0b] italic drop-shadow-sm">
      ...
      {items.length > 0 && !bookingCode && (
        <div className="p-6 bg-[#0b0f1a] border-t border-white/5 space-y-4 shrink-0 relative">
          ...
          <div className="flex justify-between items-center px-1">
            <span className="text-[10px] font-black uppercase italic text-slate-500 tracking-[0.1em]">Total Combined Odds</span>
          ...
          <div className="bg-[#1c2636]/60 border border-white/5 rounded-2xl p-4 flex justify-between items-center focus-within:border-[#10b981]/50 transition-all">
            <span className="text-[9px] font-black uppercase italic text-slate-400">Stake (KES)</span>
          ...
          <div className="px-1 flex flex-col gap-1">
            ...
            <div className="flex justify-between items-center">
                ...
                <span className="font-black text-2xl italic tracking-tighter text-[#10b981]">
          ...
          <button 
            ...
            className="group w-full font-black py-5 rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-[0.97] bg-[#10b981] text-[#0b0f1a] hover:bg-[#14d393] hover:shadow-[0_0_30px_rgba(16,185,129,0.3)] disabled:opacity-50 disabled:grayscale"
          >
